...
inline unsigned pg_ofs(const void *va)
{
  return (uintptr_t)va & PGMASK;
}

/* Virtual page number. */
inline uintptr_t pg_no(const void *va)
{
  return (uintptr_t)va >> PGBITS;
}

/* Round up to nearest page boundary. */
inline void *pg_round_up(const void *va)
{
...
static inline bool
is_valid_user_pointer(const void *pt, int size)
{
  return pt + size <= PHYS_BASE;
}
